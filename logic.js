...
export const EXERCISES = {
  bench:    { name: 'Bench press',              sets: 3, min: 5,  max: 8,  step: 2.5, main: true },
  row:      { name: 'Barbell row',              sets: 3, min: 6,  max: 10, step: 2.5, main: true },
  dbpress:  { name: 'Dumbbell overhead press',  sets: 3, min: 8,  max: 12, step: 2 },
  pulldown: { name: 'Lat pulldown',             sets: 3, min: 8,  max: 12, step: 5 },
  squat:    { name: 'Back squat',               sets: 3, min: 5,  max: 8,  step: 2.5, main: true },
  rdl:      { name: 'Romanian deadlift',        sets: 3, min: 8,  max: 10, step: 2.5 },
  lunge:    { name: 'Walking lunge (per leg)',  sets: 2, min: 10, max: 10, step: 2 },
  plank:    { name: 'Plank (seconds)',          sets: 3, min: 30, max: 60, step: 0, unit: 's' },
  ohp:      { name: 'Overhead press',           sets: 3, min: 5,  max: 8,  step: 2.5, main: true },
  pullup:   { name: 'Pull-up (added kg)',       sets: 3, min: 5,  max: 10, step: 2.5, main: true },
  incline:  { name: 'Incline dumbbell bench',   sets: 3, min: 8,  max: 12, step: 2 },
  dbrow:    { name: 'Single-arm row (per arm)', sets: 3, min: 10, max: 10, step: 2 },
  deadlift: { name: 'Deadlift',                 sets: 3, min: 5,  max: 5,  step: 2.5, main: true },
  goblet:   { name: 'Goblet squat',             sets: 3, min: 10, max: 12, step: 2 },
  stepup:   { name: 'Step-up (per leg)',        sets: 2, min: 10, max: 10, step: 2 },
};
